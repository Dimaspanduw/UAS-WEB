  ...
  <body>
    ...
    <section id="aboutme">
      ...
      <div class = "content">
          <h2>About Me</h2>
          <span><!-- line here --></span>
          <p>Nama : Dimas Pandu Winata<br>Nim : 2109106141 <br> Prodi : Informatika C'21 <br> Contact Person :
          </p>
          <ul class = "icons">
              <a href="https://wa.me/+6281347315754/?text=mariberteman"><p><button class="button">Contact</button></p></a>
          </ul>
      </div>
